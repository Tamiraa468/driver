-- ============================================================================
-- FIX: get_available_tasks — use pickup_note / dropoff_note
-- Remote delivery_tasks does not have pickup_address / dropoff_address columns.
-- Alias pickup_note/dropoff_note as pickup_address/dropoff_address for the client.
-- ============================================================================
...
BEGIN
    ...
    SELECT
        ...
        dt.pickup_note       AS pickup_address,
        dt.dropoff_note      AS dropoff_address,
        dt.pickup_note,
        dt.dropoff_note,
        dt.note,
        dt.package_value,
