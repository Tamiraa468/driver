-- ============================================================================
-- FIX: get_available_tasks — remove locations JOIN
-- Remote delivery_tasks uses pickup_note / dropoff_note for addresses.
-- Alias them as pickup_address / dropoff_address so the client API stays stable.
-- ============================================================================
